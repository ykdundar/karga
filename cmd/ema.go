...
var emaCmd = &cobra.Command{
	Use:   "ema",
	Short: "Exponential moving average (EMA) values",
	Long:  "Exponential moving average (EMA) values",
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println(internal.EMARequest(symbol, interval, timePeriod, seriesType))
	},
}
...
func init() {
	...
	emaCmd.PersistentFlags().IntVarP(&timePeriod, "timeperiod", "t", 60, "Number of data points used to calculate each RSI value. Positive integers are accepted (e.g., timeperiod=60, timeperiod=200)")
